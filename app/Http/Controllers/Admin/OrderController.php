		...
		<div class="container">
			<div class="details clearfix">
				...
				<div class="data right">
					...
					<div class="date">
    Oder Date: ' . date('Y-m-d h:i:s', strtotime($orderDetails['created_at'])) . '<br>
    Order Amount: تومان  ' . $orderDetails['grand_total'] . '<br>
      Order status: تومان  ' . $orderDetails['order_status'] . '<br>
      Payment Method: تومان  ' . $orderDetails['payment_method'] . '<br>
    </div>
				</div>
			</div>
        ...
        foreach ($orderDetails['orders_products'] as $product) {
            ...
            $invoiceHTML .= '  <tr>
						...
						<td class="total">تومان' . $product['product_price'] . '</td>
						<td class="total">تومان' . $product['product_qty'] * $product['product_price'] . '</td>
					</tr>';
				...
				<table class="grand-total">
					<tbody>
						...
						<tr>
							...
							<td class="desc"></td>
							<td class="desc" ></td>
							<td class="unit" colspan="2">SHIPPING CHARGEs:</td>
        ...
        if ($orderDetails['coupon_amount']>0) {
            $invoiceHTML .= '<td class="total">' . $orderDetails['coupon_amount'] . ' تومان </td>  ';
        }else{
            $invoiceHTML .= '<td class="total">0 تومان</td>  ';
        }
        $invoiceHTML .= '
						</tr>
						<tr>
