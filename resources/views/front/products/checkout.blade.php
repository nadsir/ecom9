                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                @foreach($deliveryAddresses as $address)
                                    ...
                                    @endforeach
                                    <br>
                                    <h4 class="section-h4">اضافه کردن آدرس دریافت جدید</h4>
                                    <div class="u-s-m-b-24">
                                        <input type="checkbox" class="check-box" id="ship-to-different-address" data-toggle="collapse" data-target="#showdifferent">
                                        <label class="label-text" for="ship-to-different-address">دریافت با آدرس جدید ؟</label>
                                    </div>
                                ...
                                <h4 class="section-h4">آدرس دریافت سفارشات شما</h4>
