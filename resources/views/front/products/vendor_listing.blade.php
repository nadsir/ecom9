...
@section('content')
                    ...
                    <div class="page-bar clearfix">
                        <!--                        <div class="shop-settings">
                                                    ...
                                                    <a id="grid-anchor" class="active">
                                                        <i clas s="fas fa-th"></i>
                                                    </a>
                                                </div>-->
                        <!-- Toolbar Sorter 1  -->
    <?php /*   <form action="" name="sortProducts" id="sortProducts">
    ...
    <?php /*  <div class="toolbar-sorter-2">
                    ...
                    @if(isset($_GET['sort']))
                        <div class="mt-3 mb-3" >{{$vendorProducts->appends(['sort'=>$_GET['sort']])->links()}}</div>
                    @else
                        <div class="mt-3 mb-3" >{{$vendorProducts->links()}}</div>
                    @endif
