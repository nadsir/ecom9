                                    ...
                                    <div class="row">
                                        <div class="col-sm-12"><table id="example1" class="table table-bordered table-striped dataTable" role="grid">
                                                ...
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 446.8px;" aria-label="نام: activate to sort column ascending">شماره فیلتر</th>
                                                    ...
                                                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 446.8px;" aria-label="نام: activate to sort column ascending">مقدار فیلتر</th>
                                                ...
                                                @foreach($filters_values as $filter)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php
                                                            echo $getFilterName=ProductsFilter::geFilterName($filter['filter_id']);
                                                            ?>
                                                        </td>
                                                        <td>{{$filter['filter_value']}}</td>
                                                        <td>
                                                            @if($filter['status'] ==1)
                                                                <i status="Active" filter-id="{{$filter['id']}}" id="filter-{{$filter['id']}}"  ref="input" class=" fa" :class="activeClass" v-on:click="changeFilterValueStatus('filter-'+{{$filter['id']}})" style="font-size:24px"></i>
                                                            @else
                                                                <i status="Deactive" filter-id="{{$filter['id']}}" id="filter-{{$filter['id']}}"  ref="input" class=" fa" :class="deactiveClass" v-on:click="changeFilterValueStatus('filter-'+{{$filter['id']}})" style="font-size:24px"></i>
                                                            @endif
                                                        </td>
                                                        <td>
