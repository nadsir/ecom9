                                            ...
                                            <div class="col-sm-12"><table id="example1" class="table table-bordered table-striped dataTable" role="grid">
                                                    ...
                                                    @foreach($brands as $brand)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                @if($brand['status'] ==1)
                                                                    <i status="Active" brand-id="{{$brand['id']}}" id="brand-{{$brand['id']}}"  ref="input" class=" fa" :class="activeClass" v-on:click="changeBrandStatus('brand-'+{{$brand['id']}})" style="font-size:24px"></i>
                                                                @else
                                                                    <i status="Deactive" brand-id="{{$brand['id']}}" id="brand-{{$brand['id']}}"  ref="input" class=" fa" :class="deactiveClass" v-on:click="changeBrandStatus('brand-'+{{$brand['id']}})" style="font-size:24px"></i>
                                                                @endif
                                                            </td>
                                                            <td>
                                                                ...
                                                                <a href="">
                                                                    ...
                                                                    <a href="{{url('admin/add-edit-brand/'.$brand['id'])}}" style="padding: 10px">
                                                                        <i class="fa fa-pencil-square-o" style="font-size:24px;color:green"></i>
                                                                    </a>
<!--                                                                    <a  href="{{url('admin/delete-brand/'.$brand['id'])}}" title="brand" id="delete-{{$brand['id']}}" v-on:click="confirmDelete('delete-'+{{$brand['id']}})" style="padding: 10px">
                                                                        <i class="fa fa-trash-o" style="font-size:24px;color:red"></i>
                                                                    </a>-->
                                                                    <a module="brand" moduleid="{{$brand['id']}}"  href="javascript:void(0)" title="brand" id="delete-{{$brand['id']}}" v-on:click="confirmDelete('delete-'+{{$brand['id']}})" style="padding: 10px">
                                                                        <i class="fa fa-trash-o" style="font-size:24px;color:red"></i>
                                                                    </a>
                                                                </a>
