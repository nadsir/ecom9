                            ...
                            <div class="card card-primary" style="height: 100%">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="vendor_address" placeholder=""
                                               value="{{$vendorDetails['vendor_business']['shop_address']}}" name="vendor_address" readonly="">
                                    </div>
                                    <div class="form-group">
                                        <label for="vendor_city">شهر محل کسب</label>
                                        <input type="text" class="form-control" id="vendor_city" placeholder=""
                                               value="{{$vendorDetails['vendor_business']['shop_city']}}" name="vendor_city" readonly="">
                                    </div>
                                    <div class="form-group">
                                        <label for="vendor_state">  استان محل کسب</label>
                                        <input type="text" class="form-control" id="vendor_state" placeholder=""
                                               value="{{$vendorDetails['vendor_business']['shop_state']}}" name="vendor_state" readonly="">
                                    </div>
                                    <div class="form-group">
                                        <label for="vendor_country">کشور محل کسب</label>
                                        <input type="text" class="form-control" id="vendor_country" placeholder=""
                                               value="{{$vendorDetails['vendor_business']['shop_country']}}" name="vendor_country" readonly="">
                                    </div>
                                    <div class="form-group">
                                        <label for="vendor_pincode">کد اقتصادی</label>
                                        <input type="text" class="form-control" id="vendor_pincode" placeholder=""
                                               value="{{$vendorDetails['vendor_business']['shop_pincode']}}" name="vendor_pincode" readonly="">
                                    </div>
                                    <div class="form-group">
                                        <label for="vendor_mobile">شماره محل کار</label>
                                        <input type="text" class="form-control" id="vendor_mobile" placeholder=""
                                               value="{{$vendorDetails['vendor_business']['shop_mobile']}}" name="vendor_mobile" readonly="">
                                    </div>
                                    <div class="form-group">
                                        <label for="vendor_email">وب سایت فروشگاه</label>
                                        <input type="vendor_email" class="form-control" id="vendor_email" placeholder=""
                                               value="{{$vendorDetails['vendor_business']['shop_website']}}" name="vendor_email" disabled>
                                    </div>
                                    <div class="form-group">
                                        <label for="vendor_email">آدرس ایمیل فروشنده</label>
                                        <input type="vendor_email" class="form-control" id="vendor_email" placeholder=""
                                               value="{{$vendorDetails['vendor_business']['shop_email']}}" name="vendor_email" disabled>
                                    </div>
                                    <div class="form-group">
                                        <label for="vendor_email">آدرس کد پستی</label>
                                        <input type="vendor_email" class="form-control" id="vendor_email" placeholder=""
                                               value="{{$vendorDetails['vendor_business']['address_proof']}}" name="vendor_email" disabled>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="vendor_email" class="form-control" id="vendor_email" placeholder=""
                                               value="{{$vendorDetails['vendor_business']['business_license_number']}}" name="vendor_email" disabled>
                                    </div>
                                    <div class="form-group">
                                        <label for="vendor_email">Gst Number</label>
                                        <input type="vendor_email" class="form-control" id="vendor_email" placeholder=""
                                               value="{{$vendorDetails['vendor_business']['gst_number']}}" name="vendor_email" disabled>
                                    </div>
                                    <div class="form-group">
                                        <label for="vendor_email">Pan Number</label>
                                        <input type="vendor_email" class="form-control" id="vendor_email" placeholder=""
                                               value="{{$vendorDetails['vendor_business']['pan_number']}}" name="vendor_email" disabled>
                                    </div>
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="vendor_email" class="form-control" id="vendor_email" placeholder=""
                                           value="{{$vendorDetails['vendor_bank']['account_holder_name']}}" name="vendor_email" disabled>
                                </div>
                                <div class="form-group">
                                    <label for="vendor_name">نام بانک</label>
                                    <input type="text" class="form-control" id="vendor_name" placeholder=""
                                           value="{{$vendorDetails['vendor_bank']['bank_name']}}" name="vendor_name" readonly="">
                                </div>
                                <div class="form-group">
                                    <label for="vendor_address">شماره حساب</label>
                                    <input type="text" class="form-control" id="vendor_address" placeholder=""
                                           value="{{$vendorDetails['vendor_bank']['account_number']}}" name="vendor_address" readonly="">
                                </div>
                                <div class="form-group">
                                    <label for="vendor_city">کد بانک</label>
                                    <input type="text" class="form-control" id="vendor_city" placeholder=""
                                           value="{{$vendorDetails['vendor_bank']['bank_ifcs_code']}}" name="vendor_city" readonly="">
                                </div>
